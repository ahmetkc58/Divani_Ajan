...
$env:KARAYOL_COMPETITION_SNAPSHOT_PATH = "data/processed/uab_ministry_archive_snapshot.json"
$env:KARAYOL_QDRANT_PATH = "runtime/qdrant-uab-ministry-archive"
$env:KARAYOL_QDRANT_COLLECTION = "uab_ministry_archive_chunks_v1"
