...
from karayol_agent.llm import OllamaClient
    ...
    def __init__(
        ...
        *,
        ...
        llm_client = (
            ...
            if app_settings.llm_backend == "ollama"
            else None
        )
        self.classifier = ClassificationAgent(llm_client=llm_client)
        self.analyzer = ContentAnalysisAgent(llm_client=llm_client)
